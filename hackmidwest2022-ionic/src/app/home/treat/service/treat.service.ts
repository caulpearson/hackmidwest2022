...
export class TreatService {
  ...
  getCovidTreatmentDataByStateAndCity(state: string,city: string): Observable<Object>{
    return this.http.get('https://healthdata.gov/resource/6m8a-tsjg.json?state='+state+'&city='+city);
  }
